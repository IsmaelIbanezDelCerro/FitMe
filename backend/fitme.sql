...
--
-- Table structure for table `dia_menu`
--
...
--
-- Dumping data for table `dia_menu`
--

LOCK TABLES `dia_menu` WRITE;
/*!40000 ALTER TABLE `dia_menu` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `dia_menu` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ejercicio` (
  ...
  `repeticiones` int(11) DEFAULT NULL COMMENT 'NULL = al fallo',
...
--
-- Table structure for table `gimnasio_cercano`
--
...
--
-- Dumping data for table `gimnasio_cercano`
--

LOCK TABLES `gimnasio_cercano` WRITE;
/*!40000 ALTER TABLE `gimnasio_cercano` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `gimnasio_cercano` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `preferencia_alimenticia`
--
...
--
-- Dumping data for table `preferencia_alimenticia`
--

LOCK TABLES `preferencia_alimenticia` WRITE;
/*!40000 ALTER TABLE `preferencia_alimenticia` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `preferencia_alimenticia` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `registro_peso`
--
...
--
-- Dumping data for table `registro_peso`
--

LOCK TABLES `registro_peso` WRITE;
/*!40000 ALTER TABLE `registro_peso` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `registro_peso` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-11 13:18:50
